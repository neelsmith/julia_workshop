...
md"""Much of your scholarly work will involve working with lists like Vectors.  The Pluto notebook for session 1b will take introduce you to the basics of working with collections of data in Julia.
